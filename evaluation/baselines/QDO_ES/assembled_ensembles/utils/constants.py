SUPPORTED_CLASSIFIER = ["AB", "BNB", "DTREE", "GB", "GNB", "KNN_CLASS", "LDA", "LSVM", "MLP", "MNB", "PA", "QDA", "RF",
                        "SGD", "SVM", "XT"]

SUPPORTED_COMBINER = ["BC", "BKS", "DTEMP", "DS", "COS", "KNN_COMB", "MAMV", "MIMV", "MLE", "NB", "NN", "AVG", "WV"]
