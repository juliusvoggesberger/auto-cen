...
from auto_cen.pusion.utils.exceptions import ValidationError
...
class Combiner:
    ...
    - `pusion.utils.constants.Problem`
    - `pusion.utils.constants.AssignmentType`
    - `pusion.utils.constants.CoverageType`
